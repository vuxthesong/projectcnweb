...
$sql = "SELECT `Mathu`,`emailgui`, `Chudethu`, `Ngaygui`,`Noidung`,`emailnhan` FROM `db_thungrac` WHERE Mathu = $ma_thu ";
...
<main>
    <div class="container-noidunggamil">
        <div class="content ps-4  overflow-auto  ">
            ...
            <a href="thungrac.php" type="button" class="btn btn-secondary mt-3">Quay lại</a>         
        </div>
    </div>
</main>
