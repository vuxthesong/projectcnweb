        ...
        <div class="content ps-4  overflow-auto  ">
            ...
            ?>
                    <div class="col-md-12 mt-5 ">
                        <a href="traloimailden.php?emailgui=<?php echo $row['emailgui']; ?>&Chudethu=<?php echo $row['Chudethu']; ?>" type="button" class="btn btn-secondary me-2"><i class="bi bi-arrow-90deg-left"></i> Trả lời </a>
