                                ...
                                <div class="noidung-gmail container-fluid">
                                    <table class="table table-hover table-ms table-responsive align-middle">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT `Mathu`,`emailnhan`, `Chudethu`, `Ngaygui` FROM `db_hopthu` WHERE emailgui = 'song@gmail.com'";
                                            ...
                                            ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="#"><i class="bi bi-star-fill text-warning ms-4"></i></a></td>
                                                        <td><a href="#"><i class="bi bi-book ms-4"></i></a></td>
                                                        <td><a href="delete_mail2.php?Mathu=<?php echo $row['Mathu']; ?>"><i class="bi bi-trash ms-2 "></i></a></td>
