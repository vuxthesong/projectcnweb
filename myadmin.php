...
<main>
        ...
        <form class="form-signin" action="process_myadmin.php" method="post">
            ...
            <input type="text" id="inputEmail" name="txtEmail" class="form-control" placeholder="Email address" required autofocus>
            ...
            <button class="btn btn-lg btn-primary btn-block" type="submit" name="btnSignInad" >Sign in</button>
