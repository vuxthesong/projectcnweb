<?php
    ...
    $sql1 = "SELECT * FROM db_hopthu WHERE Mathu = '$ma_thu' and mamail = 1 ";
    ...
    $sql2 = "INSERT INTO `db_thungrac`(`Mathu`, `emailgui`, `emailnhan`, `Chudethu`, `Noidung`, `Ngaygui`,`mamail`) 
                VALUES ('$Mathu','$email_gui','$email_nhan','$Chude','$Noidung','$Ngaygui',1)";
    // echo $sql;
    ...
    //Xoa khoi hom thu
    $sql3 = "DELETE FROM db_hopthu WHERE Mathu = '$ma_thu' and mamail = 1 ";
